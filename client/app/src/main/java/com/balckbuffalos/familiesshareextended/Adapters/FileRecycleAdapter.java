...
public class FileRecycleAdapter extends  RecyclerView.Adapter<FileRecycleAdapter.ViewHolder>{
    ...
    public FileRecycleAdapter(Context mContext, ArrayList<String> mFileId, ArrayList<String> mMemberName, ArrayList<String> mDescription, ArrayList<String> mDate, ArrayList<String> mFileType, String group_id, String user_id, String token) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.download.setOnClickListener(v -> {
            getFile(token, group_id, user_id, mFileId.get(position));
        });
    }
