...
public class ActivitiesCreationActivity extends AppCompatActivity implements StepperLayout.StepperListener {
    ...
    public void onCompleted(View completeButton) {
        ...
        try {
            ...
            startTime.put("dateTime", "2021" + "-" + data_inizio.getMonth() + "-" + data_inizio.getDate() + "T" + ora_inizio + ":" + (minuto_inizio<10?"0":"") + minuto_inizio + ".000Z");
            startTime.put("date", null);
            endTime.put("dateTime", "2021" + "-" + data_fine.getMonth() + "-" + data_fine.getDate() + "T" + ora_fine + ":" + (minuto_fine<10?"0":"") + minuto_fine + ".000Z");
