...
public class ActivitiesCreationActivity extends AppCompatActivity implements StepperLayout.StepperListener {
    ...
    SwitchMaterial switch_green_pass;
    ...
    public void onCompleted(View completeButton) {
        ...
        switch_green_pass = findViewById(R.id.switch_green_pass);
        ...
        boolean green_pass = switch_green_pass.isChecked();
    ...
    private void createActivity(String token, String id, String user_id, String title, String description, String position, @ColorInt int color, boolean green_pass,
                                Date startDate, int startHour, int startMinute , Date endDate, int endHour, int endMinute) {
        compositeDisposable.add(myAPI.createActivity(token, id, user_id, title, description, position, color, green_pass, startDate, startHour, startMinute, endDate, endHour, endMinute)
